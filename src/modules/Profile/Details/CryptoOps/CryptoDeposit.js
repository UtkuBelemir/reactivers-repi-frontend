...
import CryptoDepositHistory from './DepositHistory';
                        ...
                        <div className="container">
                            <div className="container-cell">
                                <p>Dikkat! Bu adrese
                                    ...
                                    transferler geçersizdir. İşleminiz madenciler tarafından onaylandıktan sonra
                                    bakiyeniz
                                    güncellenecektir.</p>
                            </div>
                            <div className="container-cell">
                        <span style={{fontSize: 16, marginLeft: 8}}><Icon
                            ...
                            <Tooltip visible={true} placement="right" title={
                                <span style={{cursor: 'pointer'}}>
                                    <CopyToClipboard
                                        onCopy={() => this.props.showNotification("Adres Başarıyla Kopyalandı!", "success", "addr_copied")}
                                        text={depositAddress}>
